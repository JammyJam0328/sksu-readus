                            ...
                            <div class="flex-shrink-0">
                                @if ($post->user->google_id)
                                    <img class="w-10 h-10 rounded-full"
                                        src="{{ $post->user->profile_photo_path ? $post->user->profile_photo_url : $post->user->google_profile_photo }}"
                                        alt="">
                                @else
                                    <img class="w-10 h-10 rounded-full"
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm text-gray-500">
                                    <a href="#"
                                        ...
                                        <time
                                            datetime="2020-12-09T11:43:00">{{ $post->created_at->format('F j, Y ') }}
                                            at
                                            {{ $post->created_at->format('g:i a') }}</time>
                                    </a>
                                </p>
                            </div>
                        </div>
                        <h2 id="question-title-81614"
                            class="mt-4 text-base font-medium text-gray-900">{{ $post->title }}</h2>
                    </div>
                ...
                <div class="flex justify-center">
                    <svg data-name="Layer 1"
                        ...
                        <path
                            ...
                            transform="translate(-72.23827 -23.97221)"
                            opacity="0.1" />
                        <path d="M572.85788,134.5298c1.81006-6.05648,1.81051-7.74495,1.81051-7.74495Z"
                            transform="translate(-72.23827 -23.97221)"
                            opacity="0.1" />
                        <path
