<div x-data="{action:'none'}"
    ...
    <div class="mt-3">
        <div x-show="action=='none'">
            @include('admin-pages.components.post.post-list')
        </div>
        <div x-cloak
                ...
                <div class="">
                    <div class="justify-center flex-auto p-5 text-center">
                        ...
                        <h2 class="py-4 text-xl font-bold ">Are you sure?</h3>
                            <p class="px-8 text-sm text-gray-500">Do you really want to delete this post?
                    ...
                    <div class="p-3 mt-2 space-x-4 text-center md:block">
                        ...
                        <button wire:click.prevent="deletePost"
