        ...
        <div class="">
            <div class="border-b border-gray-200">
                <nav class="flex -mb-px"
                    aria-label="Tabs">
                    <button wire:click="$set('filter','School')"
                        type="button"
                        class="{{ $filter == 'School'? 'border-indigo-500 text-indigo-600': 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} w-1/2 px-1 py-2 text-sm font-medium text-center text-gray-500 border-b-2 ">
                        School </button>

                    <button wire:click="$set('filter','Campus')"
                        type="button"
                        class="{{ $filter == 'Campus'? 'border-indigo-500 text-indigo-600': 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} w-1/2 px-1 py-2 text-sm font-medium text-center text-gray-500 border-b-2 ">
                        {{ auth()->user()->campus->name }} </button>
                </nav>
            </div>
        </div>
    </div>
