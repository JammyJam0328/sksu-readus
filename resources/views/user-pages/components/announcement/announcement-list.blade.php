   @forelse ($announcements as $announcement)
       <div x-data="{expanded:false}"
           x-id="['announcement']"
           wire:click.prevent="clickAnnouncement('{{ $announcement->id }}','{{ $announcement->user_id }}')"
           class="p-4 bg-gray-100 rounded-md cursor-pointer hover:bg-gray-200">
           <div class="flex">
               ...
               <div class="ml-3">
                   ...
                   <div class="mt-1">
                       <span class="text-xs">Created By : {{ $announcement->user->name }}</span>
                   </div>
   ...
   @empty
       <div>
           <div class="grid justify-center space-y-2 border-t border-gray-200">
               <svg data-name="Layer 1"
                   xmlns="http://www.w3.org/2000/svg"
                   class="mt-2 w-52 h-52"
                   ...
                   <path
                       ...
                       transform="translate(-277.76855 -165.47095)"
                       fill="#e6e6e6" />
                   <polygon points="419.548 556.311 407.288 556.311 401.456 509.023 419.55 509.023 419.548 556.311"
                       fill="#a0616a" />
                   <path
                       ...
                       fill="#2f2e41" />
                   <polygon points="470.548 556.311 458.288 556.311 452.456 509.023 470.55 509.023 470.548 556.311"
                       fill="#a0616a" />
                   <path
                   ...
                   <path
                       ...
                       transform="translate(-277.76855 -165.47095)"
                       fill="#2f2e41" />
                   <path d="M921.23145,734.52905h-350a1,1,0,0,1,0-2h350a1,1,0,0,1,0,2Z"
                       transform="translate(-277.76855 -165.47095)"
                       fill="#ccc" />
                   <path
