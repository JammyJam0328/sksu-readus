 <form>
     ...
     <div class="divide-y divide-gray-200">
         <div>
             <div>
                 <h3 class="text-lg font-medium leading-6 text-center text-indigo-500">Create New Event
                 </h3>
             </div>
             <div class="grid grid-cols-1 mt-2 gap-y-3 gap-x-4 sm:grid-cols-6">
                 ...
                 <div class="sm:col-span-6">
                     ...
                     <div class="mt-1">
                         <input wire:model.defer="start_date"
                             type="datetime-local"
                             name="date-start"
                             id="date-start"
                             class="flex-1 block w-full min-w-0 border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                 ...
                 <div class="sm:col-span-6">
                     ...
                     <div class="mt-1">
                         <input wire:model.defer="end_date"
                             type="datetime-local"
                             name="date-end"
                             id="date-end"
                             class="flex-1 block w-full min-w-0 border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                 ...
                 <div class="sm:col-span-6">
                     ...
                     <select wire:model.defer="publicity"
                         id="for"
                         name="for"
