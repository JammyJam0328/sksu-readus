            ...
            <div class="mt-5 border-t border-gray-200">
                <dl class="sm:divide-y sm:divide-gray-200">
                    <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $event->user->name }}</dd>
                    </div>
                    <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                        <dt class="text-sm font-medium text-gray-500">Title</dt>
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $event->title }}</dd>
                    </div>
                    <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                        <dt class="text-sm font-medium text-gray-500 ">Description</dt>
                        <pre
                            class="mt-1 text-sm text-gray-900 break-words whitespace-pre-line sm:mt-0 sm:col-span-2 font-roboto">
                                                                        {{ $event->description }} Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sapiente
                                                                        architecto facilis nihil fuga, dicta sed amet doloremque, magnam doloribus assumenda a porro
                                                                        esse est consequatur magni nam voluptatem. Aliquid, voluptate?
                                                                    </pre>
                    </div>
                    <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                    ...
                    <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                            {{ date('M d, Y H:s A', strtotime($event->end_date)) }}</dd>
                    </div>
                    <hr>
                </dl>
            </div>
